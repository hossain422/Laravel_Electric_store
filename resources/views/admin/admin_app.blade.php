...
>
  <head>
    ...
    <title>@yield('title') | Admin of Electric Store</title>
  ...
  <body>
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a target="_blank" href="{{url('/')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
            ...
            <li class="menu-item {{ request()->is('admin/category') ? 'active' : '' }} {{ request()->is('admin/sub_category') ? 'active' : '' }} ">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item {{ request()->is('admin/sub_category') ? 'active' : '' }}">
                  <a href="{{url('admin/sub_category')}}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-home-circle"></i>
            ...
            <li class="menu-item {{ request()->is('admin/order') ? 'active' : '' }}">
              <a href="{{url('admin/order')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Manage Orders</div>
              </a>
            </li>
    ...
    @include('admin.category_js')
    @include('admin.sub_category_js')
    @include('admin.brand_js')
