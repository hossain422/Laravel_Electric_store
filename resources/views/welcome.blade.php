                            ...
                            <!-- start old  -->
                             <div class="col-lg-12">
                                <div class="filter-category-container">
                                    ...
                                    <div class="filter__category-wrapper">
                                    <button class="btn filter__btn filter__btn--style-2" type="button" data-filter=".fil{{$category->id}}">{{$category->sub_category_name}}</button>
                                    </div>
                                    @endforeach
                                     <!-- <div class="filter__category-wrapper">
                                ...
                                <div class="filter__grid-wrapper u-s-m-t-30">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 u-s-m-b-30 filter__item fil ">
